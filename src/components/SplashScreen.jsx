...
const gifts = ["hehe.gif", "goma-hearth.gif", "peach-goma.gif", "hello.gif"];
      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <div className="relative flex flex-col lg:flex-row my-auto items-center min-w-[200px] lg:min-w-[300px]">
              <AnimatePresence mode="wait">
                ...
                >
                  <span className="text-accent uppercase whitespace-nowrap">
                    {roles[index]}
                  </span>
                  <img
          ...
          <div className="fixed bottom-0 left-0 w-full overflow-hidden">
            <motion.div
              className="flex justify-center mb-1 text-accent font-semibold p-5"
              initial={{ scale: 1 }}
